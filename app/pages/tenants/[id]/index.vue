...
const unitId = computed(() => route.query.unitId as string)
const floorId = computed(() => route.query.floorId as string)
...
const { data, status, refresh } = await useLazyAsyncData(
  ...
  () => {
    ...
    if (unitId.value) queryParams.append('unitId', unitId.value)
